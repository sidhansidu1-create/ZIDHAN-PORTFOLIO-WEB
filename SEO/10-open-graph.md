# Open Graph & Twitter/X Social Metadata Specifications

This document defines the social graph metadata for rich preview snippets across WhatsApp, LinkedIn, Twitter/X, Facebook, Slack, and Discord.

---

## 1. Homepage (`index.html`) Social Metadata
...
<meta property="og:image:alt" content="Muhammed Sidhan Brand Design Portfolio">
<meta property="og:site_name" content="ZIDHANZID">
...
<meta name="twitter:creator" content="@zid_dzigns">
```

---

## 2. Campaign Page (`campaign.html`) Social Metadata
...
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:image:alt" content="9-Grid Instagram Campaign Strategy by Muhammed Sidhan">
<meta property="og:site_name" content="ZIDHANZID">
<meta property="og:locale" content="en_US">
...
## 3. Recommended Social Sharing Image Previews

1. **Main Showcase Asset (`KIBBLIX_BRANDING_COVER_uqvkyc.png`):**
   * Dimensions: 1200 × 630 px (ideal 1.91:1 ratio for LinkedIn, Facebook, and Twitter Large Card).
   * High contrast dark green/gold palette instantly grabs attention in social feeds.
2. **Campaign Showcase Asset (`FRAGRO_1_oblsh9.png`):**
   * Crisp, luxury product rendering demonstrating instant aesthetic authority.
